...
-- Copy text to + register (system clipboard)
vim.keymap.set({ "n", "v" }, "<leader>y", "\"+y", { desc = "Yank into + register (clipboard)" })
...
vim.keymap.set("n", "<leader>gl", "<CMD>Telescope git_commits<CR>",
  { desc = "Show git commit titles in Telescope window" })
vim.keymap.set("n", "<leader>gb", "<CMD>Telescope git_branches<CR>",
  { desc = "Show git branch list in Telescope window" })
