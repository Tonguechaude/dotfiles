...
vim.keymap.set('n', '<leader>j', '<CMD>NavigatorDown<CR>', { desc = "Move to down pane" })
vim.keymap.set('n', '<leader>k', '<CMD>NavigatorUp<CR>', { desc = "Move to up pane" })
vim.keymap.set('n', '<leader>h', '<CMD>NavigatorLeft<CR>', { desc = "Move to left pane" })
vim.keymap.set('n', '<leader>l', '<CMD>NavigatorRight<CR>', { desc = "Move to right pane" })
