...
dashboard.section.footer.val = "Welcome to Neovim — Have a nice coding session! Hope you coding in rust !!"

-- Revenir au dashboard quand le dernier buffer est supprimé
